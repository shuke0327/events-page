...
ActiveRecord::Schema.define(version: 20161229064154) do
  ...
  create_table "accesses", force: :cascade do |t|
    ...
    t.index ["user_id", "project_id"], name: "index_accesses_on_user_id_and_project_id", unique: true, using: :btree
  ...
  create_table "memberships", id: false, force: :cascade do |t|
    ...
    t.index ["team_id", "user_id"], name: "index_memberships_on_team_id_and_user_id", using: :btree
    t.index ["user_id", "team_id"], name: "index_memberships_on_user_id_and_team_id", using: :btree
  end
